...
public class ConfigManager {
			...
			if (dsw != null) {
				...
				if (createTAtomDataSource) {
					if(tGroupDataSource.getDataSourceType().equals(DataSourceType.TbDataSource)){
						...
						throw new IllegalArgumentException("do not havae this datasource type : " + tGroupDataSource.getDataSourceType());
					}
				} else {
	...
	private List<DataSourceWrapper> parse2DataSourceWrapperList(
			...
			logger.warn("[parse2DataSourceWrapperList]dsWeightCommaStr="
					+ dsWeightCommaStr);
