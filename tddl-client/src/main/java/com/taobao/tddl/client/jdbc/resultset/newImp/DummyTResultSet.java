 ...
 * @author guangxia
 * @author junyu
 * modify closeInternal 'removethis' parameter   
 *
 */
public abstract class DummyTResultSet extends PreparedStatementExecutorCommon implements
		ResultSet {
	 ...
	 * 
	 * @param connection
	 *            当前正在用的connection,本来可以从map中取但因为效率上的考虑所以还是不这样做
	 * @param connections
	 * @param dbIndex
